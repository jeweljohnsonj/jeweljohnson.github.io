...
You can download the .R script file of the above code [here](https://github.com/jeweljohnsonj/jeweljohnson.github.io/blob/main/R_scripts/world_happiness_2021.R).

## Summary

I hope this post was helpful to you in understanding how to plot world maps in R. In short using `{ggplot2}` we have first plot a static world map using the data from The World Happiness Report 2021, then similarly using the `{leaflet}` and `{sf}` packages we plotted an interactive world map.
...
6. [Source](https://www.kaggle.com/ajaypalsinghlo/world-happiness-report-2021) for `.csv` file of World Happiness Score of countries 2021. Compiled by Ajaypal Singh in Kaggle.com.
