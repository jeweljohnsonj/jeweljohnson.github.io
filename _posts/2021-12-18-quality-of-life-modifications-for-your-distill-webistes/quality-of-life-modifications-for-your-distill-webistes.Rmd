...
> Note: This post was originally written by [Jewel Johnson](https://twitter.com/jeweljohnsonj) and copied here on {21-Dec-2021} - see the original post [here](https://jeweljohnsonj.github.io/jeweljohnson.github.io/posts/2021-12-18-quality-of-life-modifications-for-your-distill-webistes/) for a potentially updated version.
...
5. How to add last updated date in the appendix

6. How to display your Twitter feed on your distill website

7. How to add a scrolling code chunk window

8. How to add a copy to clipboard button in source code chunk
