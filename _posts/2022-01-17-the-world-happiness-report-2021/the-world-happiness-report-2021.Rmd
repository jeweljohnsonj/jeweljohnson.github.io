...
description: |
  Exploratory data analysis on World Happiness Report 2021. Plotting world map and interative world map using {ggplot2}, {sf} and {leaflet} packages in R and correlalogram using {ggstatsplot}.
author:
  - name: Jewel Johnson
