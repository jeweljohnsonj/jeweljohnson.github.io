...
If done properly, you will have a toc just like mine, which is shown on the left side of this page. If you come across any problems while implementing this feature please put it as a comment below this article. I will do my best to solve them.
...
## 6. Changing overflow to contain elements within the article body
...
## 7. Copy to clipboard button in source code chunks
...
6. How to add a scrolling code chunk window

7. How to add a copy to clipboard button in source code chunk

I hope this was useful and in case you come across some problem implementing these features, please specify it in the comments. I will try my best to fix them. In case if anyone is wondering how I was able to make panel sets within this webpage just follow this amazing tutorial [guide](https://pkg.garrickadenbuie.com/xaringanExtra/#/panelset). They are features from the `xaringanExtra` r-package. Thanks!
